        ...
        <div className="flex md:flex-col items-center md:items-start mr-4 gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-8 flex-wrap">
              ...
              <span
                key={"Team"} 
                className="bg-gray-800 dark:bg-gray-200 py-1 px-2 rounded-md text-sm font-medium font-mono whitespace-nowrap text-white dark:text-gray-900">
                {isTeam ? "Team Dev" : "Solo Dev"}
              </span>
            </div>  
          </div>
        </div>
